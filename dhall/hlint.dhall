...
let funcs = ./hlint/functions.dhall
let ignore         = funcs.ignore
let warnSimple     = funcs.warnSimple
let warnNote       = funcs.warnNote
let warnReexport   = funcs.warnReexport
let warnReexportOp = funcs.warnReexportOp
let warnLifted     = funcs.warnLifted
let hintNote       = funcs.hintNote
let hintNoteOp     = funcs.hintNoteOp

let default-extensions = ./default-extensions.dhall
